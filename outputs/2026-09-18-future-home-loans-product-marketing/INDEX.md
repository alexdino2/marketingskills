# Future Home Loans — product marketing context

**Date:** 2026-09-18  
**Brand:** Future Home Loans · future.loans · Future Financial LLC, NMLS #1621953 · Jacksonville Beach, FL  
**Scope:** Whole-company positioning, weighted to the **VA home loan** growth push in **Florida** first. Conventional purchase is the volume engine and stays in scope.  
...
To use this in Future's own project/repo (so other skills auto-read it):

```bash
mkdir -p .agents
cp outputs/2026-09-18-future-home-loans-product-marketing/product-marketing.md .agents/product-marketing.md
```
